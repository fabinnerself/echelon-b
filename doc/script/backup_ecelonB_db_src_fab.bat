...
c:
cd C:\xampp\htdocs\sisecB\doc\BD\
del db*.sql

C:\xampp\mysql\bin\mysqldump -u root sisec --routines > C:\xampp\htdocs\sisecB\doc\BD\%stamp%
rem pause
...
set backup_file=C:\backup\src_sisecB_fab_%timestamp%.zip
